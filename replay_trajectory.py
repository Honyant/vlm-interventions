...
def main(args):
    ...
    # For future reference: how to extract map seed from trajectory data
    # map_seed = trajectory_data.get("map_seed", None)
    # if map_seed is None:
    #     raise ValueError("Trajectory file does not contain map_seed information")
    ...
    env_config = {
        ...
        "cos_similarity": True,
        "map": "CTO",
        "random_seed": args.map_seed,  # Use command line argument
        "start_seed": args.map_seed,   # Some versions might use this instead
    }
