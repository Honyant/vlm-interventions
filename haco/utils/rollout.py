...
from human_in_the_loop_env import HumanInTheLoopEnv
...
def run(args, parser):
    ...
    # checkpoint_dir = "/home/anthony/HACO/haco/utils/checkpoint"
    # h5_path = os.path.join(checkpoint_dir, "saved4")
    # agent.export_policy_model(h5_path)
