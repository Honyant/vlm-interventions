...
class HACOCallbacks(DrivingCallbacks):
    def on_episode_start(
        ...
        #load weights from weights.pkl: /home/anthony/HACO/haco/run_main_exp/weights.pkl
        # with open('/home/anthony/HACO/haco/run_main_exp/weights.pkl', 'rb') as f:
    ...
    def on_train_result(self, *, trainer, result: dict, **kwargs):
        ...
        # checkpoint_dir = trainer.logdir
        # h5_path = os.path.join(checkpoint_dir, "model_checkpoint.h5")
        # trainer._export_model(trainer, h5_path)
